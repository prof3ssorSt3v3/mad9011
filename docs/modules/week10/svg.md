...
<a href="https://www.youtube.com/aVcs-zQ1q4U?start=148" target="_blanck">![SVG OMG Optimizer](./svgOMG.png)</a>
...
```xml
<!-- Alternately, use SVG shape to create the pattern --> 
...
### Resources
- [Download code (right click)](./svgCode.zip)
