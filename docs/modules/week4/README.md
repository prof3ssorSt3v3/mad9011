...
<Countdown date="2024-09-25" customMessage="No need to rush ahead. This content will be available before this week's theory class, so just focus on what we're learning this week.">
...
4. **UI Design Color**: Introduction to using color effectively in UI design, understanding color schemes and how color affects user interaction.
...
![Colour Picker](./colourPicker.png)
...
![Colour Swatches](./colourSwatches.png)
